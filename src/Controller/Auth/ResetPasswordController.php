...
class ResetPasswordController extends AbstractController
{
    ...
    public function __construct(ResetPasswordHelperInterface $resetPasswordHelper, TranslatorInterface $translator, BankRepository $bankRepository)
    {
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        try {
            ...
            $this->addFlash('reset_password_error', sprintf(
                '%s',
                 $this->translator->trans('RESET_PASSWORD_SEND_EMAIL_ERROR')
            ));
            return $this->redirectToRoute('app_forgot_password_request');
        }
        ...
        $email = (new TemplatedEmail())
            ...
            ->to($user->getEmail())
            ->subject($this->translator->trans('RESET_PASSWORD_CTA'))
